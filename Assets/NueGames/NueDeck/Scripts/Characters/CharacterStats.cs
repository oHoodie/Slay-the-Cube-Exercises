...
namespace NueGames.NueDeck.Scripts.Characters
{
    ...
    { 
        ...
        public int DecreaseAmountPerTurn { get; set; } // Number of stacks that are removed per turn
        ...
        public StatusStats(StatusType statusType, int statusValue, int decreaseAmountPerTurn = 0, bool isPermanent = false, bool isActive = false, bool canNegativeStack = false, bool clearAtNextTurn = false)
        {
            StatusType = statusType;
            StatusValue = statusValue;
            DecreaseAmountPerTurn = decreaseAmountPerTurn;
    ...
    { 
        ...
        private void SetAllStatus()
        {
            ...
            StatusDict[StatusType.Poison].DecreaseAmountPerTurn = 1;
            ...
            StatusDict[StatusType.Stun].DecreaseAmountPerTurn = 1;
            StatusDict[StatusType.Stun].OnTriggerAction += CheckStunStatus;

            StatusDict[StatusType.Gassed].DecreaseAmountPerTurn = 2;
            StatusDict[StatusType.Gassed].OnTriggerAction += DamageGassed;
        ...
        private void TriggerStatus(StatusType targetStatus)
        {
            ...
            // Remove stacks from the status effect as configured. Prevent negative stacks unless the effect allows it.
            StatusDict[targetStatus].StatusValue -= StatusDict[targetStatus].DecreaseAmountPerTurn;
            if (StatusDict[targetStatus].StatusValue < 0 && !StatusDict[targetStatus].CanNegativeStack)
                StatusDict[targetStatus].StatusValue = 0;
